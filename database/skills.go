...
func (s *Skills) ResetSkills() error {

	c, err := FindCharacterByID(s.ID)
	if err != nil {
		return err
	} else if c == nil {
	...
	/*skillPoints := 0 // Quoted out for now because EXP Table doesnt represent the correct skillpoints per level
	for i := 1; i <= c.Level; i++ {
		skillPoints += EXPs[int16(i)].SkillPoints
	}
	...
	s.Skills = json.RawMessage(`{"slots": [{}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}]}`)
	db.Insert(s)
